...
export const GenerationNumber = PositiveInt.pipe(Schema.brand("GenerationNumber"))
export type GenerationNumber = typeof GenerationNumber.Type

export const ReviewRequestNumber = PositiveInt.pipe(Schema.brand("ReviewRequestNumber"))
